...
//            intent.putExtra("songTitle", songs[nowPos].title)
//            intent.putExtra("singer", songs[nowPos].singer)
//            intent.putExtra("songPlayTime", songs[nowPos].playTime)
            intent.putExtra("song", songs[nowPos])
